...
# This function checks if the user will knock of peer into the cave throughout
# the game.
...
# This function checks if the user is running or fighting
def fight_or_run_check(animal, reply, items):
    ...
    if (reply == '1' and flag == 1):
        print_pause("As the wicked " + animal + " moves to attack, you unsheat"
                    "h your new sword.")
        print_pause("The Sword of Ogoroth shines brightly in your hand as you"
                    "brace yourself for the attack.")
        print_pause("But the wicked " + animal + " takes one look at your shin"
                    "y new toy and runs away!")
        print_pause("You have rid the town of the wicked " + animal + " You ar"
                    "e victorious!")
        restart_game()
...
def play_game():
    ...
    print_pause("You find yourself standing in an open field, filled with gras"
                "s and yellow wildflowers.")
    print_pause("Rumor has it that a " + animal + " is somewhere around here,"
